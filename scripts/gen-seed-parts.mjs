...
parts.push({
  name: "settings",
  sql: `insert into public.site_settings (key, value) values ('company', '${esc(
...
for (const [i, job] of seed.jobs.entries()) {
  parts.push({
    name: `job_${i}`,
...
fs.writeFileSync("supabase/seed-parts.json", JSON.stringify(parts, null, 2));
